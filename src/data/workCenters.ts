...
export const workCenters: WorkCenter[] = [
  ...
  },
  {
    ...
    dailyFocus: [
      "LV4500 saddle machining cell ownership",
      "Saddle job setup",
      "Batch progress",
      "Gauge checks",
      "Macro simulation support",
    ],
    roles: ["LV4500 Operator", "Saddle Setup Operator", "Assembler", "Lead", "Supervisor"],
    coverage: { note: "Owns the LV4500 saddle machining resources plus saddle-specific assembly and gauge flow" },
    stationTabletDefault: "LV4500 saddle jobs, batch count, gauge requirement, macro simulation status, and next operator step.",
    nextBuildModules: ["JCM macro cockpit", "LV4500 cell status", "Gauge compliance", "Casting/tap compatibility", "Batch history"],
  },
  {
    id: "patch-clamps",

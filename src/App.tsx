...
export default function App() {
  ...
  function renderCurrentPage() {
    ...
    if (tab === 'orders') return <OrdersPage theme={theme} onGoToTab={navigateTo} />;
    ...
    if (tab === 'assembly') return <AssemblyDepartmentPage theme={theme} onGoToTab={navigateTo} />;
    if (tab === 'shipping') return <ShippingDepartmentPage theme={theme} onGoToTab={navigateTo} />;
    if (tab === 'qa') return <QADepartmentPage theme={theme} onGoToTab={navigateTo} />;

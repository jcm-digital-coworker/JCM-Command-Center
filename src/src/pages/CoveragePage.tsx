...
import { getAssignmentOptionsForPerson, getRoleOptionsForDepartment, getStationOptionsForDepartment } from '../data/structuredSelections';
...
export default function CoveragePage({ roleView, departmentFilter, theme = 'dark', initialView = 'hub' }: CoveragePageProps) {
  ...
  function addPerson() {
    if (!draft.name.trim() || !draft.role.trim() || !draft.station.trim()) return;

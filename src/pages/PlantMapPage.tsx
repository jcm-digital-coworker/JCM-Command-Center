...
function closeButtonStyle(theme: 'dark' | 'light'): CSSProperties { return { padding: '9px 11px', borderRadius: 6, border: '1px solid #f97316', background: theme === 'dark' ? 'rgba(249,115,22,0.12)' : 'rgba(249,115,22,0.08)', color: '#f97316', fontSize: 11, fontWeight: 900, cursor: 'pointer' }; }

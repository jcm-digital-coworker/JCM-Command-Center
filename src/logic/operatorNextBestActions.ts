  ...
  return {
    ...
    lanes: [
      ...
      },
      {
        ...
        actionLabel: reviewTraveler ? 'Go to review' : 'Check workflow',
        target: reviewTraveler ? 'REVIEW' : 'WORKFLOW',
      },
      {
        title: 'Next handoff',
        tone: 'HANDOFF',
        ...
        actionLabel: handoffTraveler ? 'Go to handoff' : 'Check workflow',
        target: handoffTraveler ? 'HANDOFF' : 'WORKFLOW',
      },
    ],
  };
}
